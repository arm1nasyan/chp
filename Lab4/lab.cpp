...
// vector<vector<char>> generateKey(int n, string text) {
...
// vector<vector<char>> generateDecriptKey(int n, string text) {
...
// string encript(int n, string text) {

//     string encripted = "";
// 	vector<vector<char>> matrix = generateKey(n, text);

//     cout << "Encript key:" << endl;
...
// string decript(int n, string text) {

//     string decripted = "";
//     vector<vector<char>> matrix = generateDecriptKey(n, text);

//     cout << "Decript key:" << endl;
//     for (int i = 0; i < matrix.size(); i++) {
//         for (int j = 0; j < matrix[i].size(); j++) {
//             cout << matrix[i][j] << " ";
//         }
...
//     cout << "Encripted text: " << encripted << endl;

//     string decripted = decript(n, encripted);
//     cout << "Decripted text: " << decripted << endl;
